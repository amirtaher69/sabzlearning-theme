...
?>
        ...
        <div class="lg:w-[1024px] xl:w-[1280px] mx-auto flex flex-col gap-2 lg:flex-row">
            ...
            <article class="w-[80%] lg:w-[336px] xl:w-[488px] mt-[50px] lg:mt-[220px] flex flex-col gap-6 mx-auto">
                ...
                <div>
                    ...
                    <h2 class="text-[14px] font-normal text-[#acacac]">Apple Airpods PRO 2 Wireless Headphones with Type-C</h2>
                </div>
            ...
            <article class="mr-0 lg:mr-[30px] flex flex-col gap-2">
                <div class="flex items-center mx-auto gap-2 mt-[50px] lg:mt-[220px] bg-[#f6f5f5] w-[80%] lg:w-[300px] xl:w-[340px] h-[56px] rounded-[8px] p-[16px]">
                ...
                <div class="w-[80%] mx-auto lg:w-full h-[86px] bg-[#f6f5f5] rounded-[10px] mt-2 flex items-center gap-2 p-[16px]">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="#888888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12 11V16" stroke="#888888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M11.9502 8H12.0502V8.1H11.9502V8Z" stroke="#888888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                    <p class="text-[12px] font-normal text-[#555656] max-w-[266px]">امکان برگشت کالا به دلیل انصراف از خرید در دسته بندی هدفون و هندزفری تنها در صورتی مورد قبول است که پلمپ کالا باز نشده باشد.</p>
                </div>
            </article>
        </div>
    </div>
    ...
    <div class="w-full px-[10px] lg:px-0">
        <div class="hidden lg:flex justify-center items-center gap-6 h-[64px] mt-3">
            ...
            <div class="block text-medium_grey">|</div>
            <a href="#question" class="text-[16px] font-normal cursor-pointer text-dark_grey">پرسش‌وپاسخ</a>
        </div>
        <div class="lg:w-[1024px] xl:w-[1280px] mx-auto ">
            ...
            <div id="comment" class="flex flex-col lg:flex-row justify-between w-full h-auto lg:w-[1024px] xl:w-[1280px] mt-[30px] mb-[30px]">
                ...
                <div class="flex w-3/4 flex-col justify-center">
                    ...
                    <div class="flex flex-col items-start gap-4 border-b-[1px] border-b-gray-200 px-2">
                        <div class="flex items-center gap-2 pt-1">
                            <svg width="20" height="20" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.0527 15V13.75C13.0527 11.5409 11.2619 9.75 9.05274 9.75H5.67773C3.4686 9.75 1.67773 11.5409 1.67773 13.75V15" stroke="#A4A4A4" stroke-width="1.5"></path><circle cx="7.47461" cy="4.0625" r="3.0625" stroke="#A4A4A4" stroke-width="1.5"></circle></svg>
                            <p class="text-sm text-dark_grey">
                                نسترن سلیمانی
                    ...
                    <div class="flex flex-col items-start gap-4 border-b-[1px] border-b-gray-200 px-2 mt-4">
                        <div class="flex items-center gap-2 pt-1">
                            <svg width="20" height="20" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.0527 15V13.75C13.0527 11.5409 11.2619 9.75 9.05274 9.75H5.67773C3.4686 9.75 1.67773 11.5409 1.67773 13.75V15" stroke="#A4A4A4" stroke-width="1.5"></path><circle cx="7.47461" cy="4.0625" r="3.0625" stroke="#A4A4A4" stroke-width="1.5"></circle></svg>
                            <p class="text-sm text-dark_grey">
                                نسترن سلیمانی
            ...
            <div id="question" class="flex flex-col lg:flex-row w-full justify-between gap-2 mb-[20px]">
                <div class="top-[192px] flex h-fit w-full lg:w-1/4 flex-col justify-start gap-4 pl-6">
                    <div class="flex w-full flex-row gap-[10px] text-[16px] font-semibold text-dark_grey">
                        <span class="text-root text-body1-fa border-r-2 border-primary-normal pr-2 text-text-normal">پرسش و پاسخ</span>
                    </div>
                    <p class="text-sm text-medium_grey">هدفون بلوتوثی اپل مدل AirPods Pro (2nd generation 2023)</p>
                    <p class="text-base font-semibold text-dark_grey">درباره ی این کالا سوالی دارید ؟ سوال خود را ثبت کنید.</p>
                    <button class="btn-root btn-outline btn-large w-full">
                        <div class="flex items-center justify-center gap-6">
                            افزودن سوال
                        </div>
                    </button>
                </div>
                <div class="flex w-full my-6 lg:my-0 lg:w-3/4 flex-col justify-center">
                    <div class="border-b-[1px] border-b-gray-200">
                        <p class="my-2 text-[14px] lg:text-base font-semibold text-dark_grey">
                            تفاوت این محصول با مشابه سایت خودتون چی هست که اختلاف قیمت دارند؟
                            https://dgland.com/product/dglp-6113/apple-airpods-pro-2-wireless-headphones            
                        </p>
                        <div class="flex w-full flex-col gap-4">
                            <div class="flex w-full gap-2">
                                <p class="my-2 w-fit rounded-md border border-semi_dark p-1 text-xs text-semi_dark cursor-pointer">
                                    ثبت پاسخ جدید
                                </p>
                            </div>
                        </div>
